...
/**
 * Normaliza flights para evitar que fechas inválidas rompan el pipeline.
 * Criterio mínimo de "vuelo utilizable":
 * - departureAirportCode + arrivalAirportCode
 * - departureDateTime válido
 */
